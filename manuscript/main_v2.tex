...
\fbox{\parbox{0.80\textwidth}{%
  \centering\vspace{2.2cm}
  \textit{[Figure placeholder: R3.10 intervention comparison + synergy.}\\
  \textit{Left: genuine tipping rate vs.\ strength for A, B, C.}\\
  \textit{Right: Bliss synergy score per strength level.}\\
  \textit{Source: results/r3\_10\_biological\_mapping/]}
  \vspace{2.2cm}%
}}
