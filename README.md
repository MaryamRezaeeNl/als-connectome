...
│
├── biorxiv/                        bioRxiv submission package
...
├── figures/                        16 static PNG figures for paper/bioRxiv (fig1–fig16)
...
> **Note:** `figures/` contains 16 static PNG files generated for the paper/bioRxiv submission.
...
> Rezaee, M. (2026). Cascade criticality, therapeutic window emergence, and pre-symptomatic
> early-warning signals in a connectome-based neurodegeneration framework: an ALS-motivated
> study on the *C. elegans* motor circuit. *bioRxiv* (submitted June 2026).
